...
export const NODE_SPECS = [
  ...
  spec({ key: "workflow", desktopType: "workflow_group", title: "工作流", description: "一组可复用的生成节点", kind: "workflow", group: "system", accent: "#65d6b2", creatable: false, input: ["any"], output: ["any"], actions: ["执行工作流", "保存工作流模板"], defaults: {} }),
