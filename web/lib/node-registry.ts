...
export const NODE_SPECS = [
  ...
  spec({ key: "multi_director", desktopType: "video_node", variant: "multi_image_director", title: "多图导演视频", description: "按时间段、动作、运镜和用途一次生成完整视频", kind: "director", group: "primary", accent: "#6f8cff", creatable: true, input: ["image", "asset"], output: ["video"], actions: ["编辑图片时间、动作、运镜与用途", "图生视频", "基于尾帧续拍", "提取首中尾帧"], defaults: { multi_image_director: true, timeline_images: [], references: [], reference_assets: [], duration: 10, ratio: "16:9", generator_kind: "video", editor_action: "图生视频" } }),
